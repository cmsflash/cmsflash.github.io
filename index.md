...
Shen Zhuoran (Zhuoran is the first name) is a Research Scientist at a [Augment](https://www.augmentcode.com/), working on coding large language models (coding LLMs) to push on the frontier of artificial intelligence (AI) reasoning and general intelligence.
